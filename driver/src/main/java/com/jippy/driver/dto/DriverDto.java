...
public class DriverDto {
    ...
    @Schema(
            ...
            example = "https://example.com/profile/driver104.jpg",
...
//    @NotNull(message = "Area id is required")
    ...
    @Schema(
            description = "Geographical longitude of the driver's location",
            example = "78.3915"
    )
...
//    =============================FOR  getDriverDetails =======================================================
    @Schema(
            description = "Indicates whether the driver is approved - for getDriverDetails",
            example = "true",
            accessMode = Schema.AccessMode.READ_ONLY
    )
    ...
    @Schema(
            description = "Indicates whether the driver is ready to accept orders - for getDriverDetails",
            example = "true",
            accessMode = Schema.AccessMode.READ_ONLY
    )
    ...
    @Schema(
            description = "Indicates whether the driver user account is active in FM. Y = Active, N = Inactive",
            example = "Y",
            accessMode = Schema.AccessMode.READ_ONLY
    )
