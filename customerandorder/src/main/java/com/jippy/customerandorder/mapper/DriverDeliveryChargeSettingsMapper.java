...
public class DriverDeliveryChargeSettingsMapper {
    ...
    public DriverDeliveryChargeSettings mapToEntity(
    ...
    public DriverDeliveryChargeSettingsResponseDto mapToResponseDto(
            DriverDeliveryChargeSettings entity) {

        DriverDeliveryChargeSettingsResponseDto responseDto =
                new DriverDeliveryChargeSettingsResponseDto();

        responseDto.setDeliveryChargeSettingId(
                entity.getDeliveryChargeSettingId());

        responseDto.setPickUpKmsRangeFrom(
                entity.getPickUpKmsRangeFrom());

        responseDto.setPickUpKmsRangeTo(
                entity.getPickUpKmsRangeTo());

        responseDto.setUnitPricePerPickKm(
                entity.getUnitPricePerPickKm());

        responseDto.setDeliveryKmsRangeFrom(
                entity.getDeliveryKmsRangeFrom());

        responseDto.setDeliveryKmsRangeTo(
                entity.getDeliveryKmsRangeTo());

        responseDto.setUnitPricePerDeliverKm(
