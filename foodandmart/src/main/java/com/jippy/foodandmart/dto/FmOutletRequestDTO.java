 ...
 * <p>
 * Single outlet creation continues to use the ID fields directly.
 * Bulk upload additionally accepts human-readable names; the bulk service
 * resolves those names to IDs before persistence.
 */
...
public class FmOutletRequestDTO {
    ...
    @Schema(description = "Merchant Id. Used for single outlet creation; resolved from merchantName during bulk upload.", example = "50")
    private Integer merchantId;

    @Schema(description = "Merchant Name. Used during bulk upload; not required for single outlet creation.", example = "ABC Foods Pvt Ltd")
    private String merchantName;

    @Schema(description = "Cuisine type IDs. Used for single outlet creation; resolved from cuisineTypeNames during bulk upload.", example = "[1, 2, 5]")
    private Integer[] cuisineType;

    @Schema(description = "Cuisine type names used during bulk upload. Multiple cuisine names can be comma separated.", example = "Indian,Chinese")
    ...
    @Schema(description = "S3 URL of the outlet image", example = "https://jippys3bucket.s3.ap-south-2.amazonaws.com/outlets/50/images/8d7f2c1a.jpg")
    ...
    @Pattern(regexp = "^[6-9]\\d{9}$", message = "Alternate outlet phone must be a valid 10-digit Indian mobile number")
    private String alternateOutletPhone;

    @Schema(description = "Whether the outlet is a vegetarian outlet", example = "true")
    private Boolean isVegOutlet;

    @Schema(description = "Whether GST is applied for the outlet", example = "false")
    ...
    @Pattern(regexp = "^\\d{14}$", message = "FSSAI Number must contain exactly 14 digits")
    ...
    /**
     * Kept required for the existing single-outlet API.
     * Bulk upload can still generate a username before service validation
     * when the CSV/Excel value is blank.
     */
    @Schema(description = "Outlet login username. For bulk upload, blank values are generated automatically.", example = "friends_outlet")
    ...
    /**
     * Kept required for the existing single-outlet API.
     * Bulk upload can still generate a password before service validation
     * when the CSV/Excel value is blank.
     */
    @Schema(description = "Outlet login password. For bulk upload, blank values are generated automatically.", example = "Rohan@123")
    ...
    // IDs remain for single outlet creation.
    private Integer stateId;
    private Integer cityId;
    private Integer areaId;

    // Names are used only by bulk upload and converted to the above IDs.
    @Schema(description = "Area Name used during bulk upload", example = "Kukatpally")
    private String areaName;

    @Schema(description = "State Name used during bulk upload", example = "Telangana")
    private String stateName;

    @Schema(description = "City Name used during bulk upload", example = "Hyderabad")
    ...
    @Schema(description = "Outlet operating days and timings")
    @Valid
    ...
    @Schema(description = "User who updated/created the outlet", example = "101")
    private Integer updatedBy;

    @Schema(description = "User/source who uploaded the bulk file", example = "Admin")
