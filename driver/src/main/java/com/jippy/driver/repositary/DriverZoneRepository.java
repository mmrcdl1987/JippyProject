...
//
    ...
    // =====================================================
    // CHECK DUPLICATE SPATIAL BOUNDARY
    // CREATE ZONE
    // =====================================================
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    boolean existsBySpatialBoundaryExcludingZone(@Param("multiPolygon") MultiPolygon multiPolygon, @Param("zoneId") Integer zoneId);
...
// FIND ACTIVE ZONE BY COORDINATES
// =====================================================
    ...
    @Query(value = """
            ...
            LIMIT 1
            """, nativeQuery = true)
    Optional<DriverZone> findActiveZoneByCoordinates(@Param("latitude") Double latitude, @Param("longitude") Double longitude);
}
