...
public class PayuWebhookController {
    ...
    public ResponseEntity<String> handleSuccessResponse(@RequestParam Map<String, String> payuParams) {
        try {
            boolean isProcessed = payuWebhookService.processPayUWebhook(payuParams);
    ...
    public ResponseEntity<String> handleFailureResponse(@RequestParam Map<String, String> payuParams) {
        try {
            boolean isProcessed = payuWebhookService.handleFailureResponse(payuParams);
