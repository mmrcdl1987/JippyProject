...
public final class FmMerchantMapper {
    ...
    /**
     * Converts Merchant Request DTO to User KYC Entity.
     *
     * @param dto      Merchant Request DTO.
     * @param merchant Saved Merchant Entity.
     * @return User KYC Entity.
     */
    public static FmUserKyc toKycEntity(FmMerchantRequestDTO dto, FmMerchant merchant) {

        FmUserKyc kyc = new FmUserKyc();

        // Common Entity Details
        kyc.setEntityId(merchant.getMerchantId());
