...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Admin Notification Update Request")
public class AdminNotificationUpdateRequestDto {
    ...
    @Schema(description = "Notification title/subject", example = "Order Confirmed", requiredMode = Schema.RequiredMode.REQUIRED)
    private String subject;

    @NotBlank(message = "Message is required")
    @Size(max = 100, message = "Message must not exceed 100 characters")
    @Schema(description = "Notification message body", example = "Your order has been confirmed successfully.", requiredMode = Schema.RequiredMode.REQUIRED)
    private String message;

    @Size(max = 1000, message = "Image URL must not exceed 1000 characters")
    @Schema(description = "Optional image URL", example = "https://example.com/order.png", nullable = true)
