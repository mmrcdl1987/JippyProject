...
@FeignClient(
        ...
        contextId = "coFeignClient",
        configuration = FeignClientConfig.class
)
public interface COFeignClient {

    @GetMapping("/api/customer/address/location")
    DriveCustomerLocationDto getCustomerLocation(
    ...
    DriveOrderPriceBreakupDto getOrderPriceBreakup(
