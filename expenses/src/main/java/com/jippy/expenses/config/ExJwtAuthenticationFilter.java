package com.jippy.expenses.config;
...
@Component
@Slf4j
public class ExJwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (!path.startsWith("/actuator") && !path.contains("api-docs") && !path.contains("swagger-ui")) {
            log.info("path: {}",path);
        }
